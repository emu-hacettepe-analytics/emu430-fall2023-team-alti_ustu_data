...
p <- ggplot(data, aes(x = reorder(Şehirler, Yanan.Hektar.Hectare), y = Yanan.Hektar.Hectare)) +
...
# Create the bar graph with cities ordered alphabetically
p <- ggplot(data, aes(x = factor(Şehirler, levels = unique(Şehirler)), y = Yanan.Hektar.Hectare)) +
  geom_bar(stat = "identity", fill = "skyblue", color = "darkblue") +
